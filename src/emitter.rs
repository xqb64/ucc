    ...
    fn emit(&mut self, f: &mut File, asm_type: &mut AsmType) -> Result<()> {
        match asm_type {
            AsmType::Byte => match self {
                ...
                AsmRegister::R12 => write!(f, "%r12b")?,
                AsmRegister::R13 => write!(f, "%r13b")?,
                AsmRegister::R14 => write!(f, "%r14b")?,
                AsmRegister::R15 => write!(f, "%r15b")?,
            ...
            AsmType::Longword => match self {
                ...
                AsmRegister::R12 => write!(f, "%r12d")?,
                AsmRegister::R13 => write!(f, "%r13d")?,
                AsmRegister::R14 => write!(f, "%r14d")?,
                AsmRegister::R15 => write!(f, "%r15d")?,
